...
* Configure the widget to use a URL to the live feed.  Also configure the widget to point to a datasource that will update the feed.  
...
* Add as a widget
* Configure to point to a datasource and url to the camera feed.
