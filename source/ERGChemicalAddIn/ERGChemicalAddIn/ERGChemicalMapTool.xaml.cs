...
namespace ERGChemicalAddIn
{
    ...
    public partial class ERGChemicalMapTool : UserControl, IMapTool, IDataSourceConsumer
    {
        ...
        //persisted members 
        //private string _ergChemicalURL = "http://arcgis-localgov-61933129.us-west-1.elb.amazonaws.com/arcgis/rest/services/PublicSafetyCOP/EMModels/GPServer/ERG%20By%20Chemical";
        ...
        //private string _ergPlacardURL = "http://arcgis-localgov-61933129.us-west-1.elb.amazonaws.com/arcgis/rest/services/PublicSafetyCOP/EMModels/GPServer/ERG%20By%20Placard";
        ...
        //private string _findNearestWSURL = "http://arcgis-localgov-61933129.us-west-1.elb.amazonaws.com/arcgis/rest/services/PublicSafetyCOP/FindNearestWS/GPServer/FindNearestWS";
        ...
        public bool Configure(System.Windows.Window owner)
        {
            var configureDialog = new Config.ERGChemicalConfigDialog(ERGChemicalURL, ERGPlacardURL, 
                WindDirectionLayerDataSource, FindNearestWSURL, WindDirectionFieldName, WindWeatherStationFieldName, WindRecordedDateFieldName) { Owner = owner };
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            if ((MapWidget != null) && (MapWidget.Map != null))
            {
                _ergChemicalToolbar = new ERGChemicalMapToolbar(MapWidget, ERGChemicalURL, ERGPlacardURL, FindNearestWSURL,
                    WindDirectionLayerDataSource, WindDirectionFieldName, WindWeatherStationFieldName, WindRecordedDateFieldName);
